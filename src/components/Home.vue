<template>
    <div id="app">
      ...
      </div> <!-- This closes the div opened with v-if="radioStation" -->
    </div>
  </template>
  ...
  import { getFirestore, collection, addDoc, where, query, getDocs, updateDoc, onSnapshot, doc, deleteDoc } from "firebase/firestore";
